...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for item in orm.Thread.objects.all():
            orm['comments_app.TappedComment'].objects.filter(content_type=66, object_pk=item.old_id).update(object_pk=item.pk)
    ...
    models = {
        ...
        u'comments_app.commenteditlog': {
            'Meta': {'object_name': 'CommentEditLog'},
            'comment': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['comments_app.TappedComment']"}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'edited_comment': ('django.db.models.fields.TextField', [], {'max_length': '3000'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'original_comment': ('django.db.models.fields.TextField', [], {'max_length': '3000'})
        },
    ...
    complete_apps = ['comments_app', 'forum']
    symmetrical = True
