...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        pass
        """
        # Deleting field 'Thread.comment'
        db.delete_column(u'forum_thread', 'comment_id')

        # Deleting field 'Thread.id'
        db.delete_column(u'forum_thread', u'id')

        # Adding field 'Thread.comment_ptr'
        db.add_column(u'forum_thread', 'comment_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['comments_app.TappedComment'], unique=True, primary_key=True, db_column='comment_id'),
                      keep_default=False)
        """
    ...
    def backwards(self, orm):
        pass
        """
        # Adding field 'Thread.comment'
        db.add_column(u'forum_thread', 'comment',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='commentthread_set', null=True, to=orm['comments_app.TappedComment'], blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Thread.id'
        raise RuntimeError("Cannot reverse this migration. 'Thread.id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Thread.id'
        db.add_column(u'forum_thread', u'id',
                      self.gf('django.db.models.fields.AutoField')(primary_key=True),
                      keep_default=False)

        # Deleting field 'Thread.comment_ptr'
        db.delete_column(u'forum_thread', 'comment_id')
        """
    ...
    models = {
        ...
        u'forum.thread': {
            'Meta': {'object_name': 'Thread', '_ormbases': [u'comments_app.TappedComment']},
            'closed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'comment_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['comments_app.TappedComment']", 'unique': 'True', 'primary_key': 'True', 'db_column': "'comment_id'"}),
            'forum': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['forum.Forum']"}),
            'latest_post': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'latestpost'", 'null': 'True', 'to': u"orm['comments_app.TappedComment']"}),
