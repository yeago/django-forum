...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'forum.thread': {
            'Meta': {'ordering': "('-id',)", 'object_name': 'Thread', '_ormbases': [u'comments_app.TappedComment']},
            'closed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'comment_ptr': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'commentptr_set'", 'unique': 'True', 'primary_key': 'True', 'db_column': "'comment_id'", 'to': u"orm['comments_app.TappedComment']"}),
            'forum': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['forum.Forum']"}),
            'latest_post': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'latestpost_set'", 'null': 'True', 'to': u"orm['comments_app.TappedComment']"}),
