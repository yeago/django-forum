...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        pass
        """
        # Adding field 'Thread.old_id'
        db.add_column(u'forum_thread', 'old_id',
                      self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True, db_column='id', blank=True),
                      keep_default=False)
        """
    ...
    def backwards(self, orm):
        pass
        """
        # Deleting field 'Thread.old_id'
        db.delete_column(u'forum_thread', 'id')
        """
    ...
    models = {
        ...
        u'forum.thread': {
            ...
            'old_id': ('django.db.models.fields.IntegerField', [], {'max_length': '10', 'null': 'True', 'db_column': "'id'", 'blank': 'True'}),
