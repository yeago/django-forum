...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'forum_category', (
            ...
            ('only_upgraders', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        # Adding field 'Forum.only_upgraders'
        db.add_column(u'forum_forum', 'only_upgraders',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Forum.category'
        db.add_column(u'forum_forum', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forum.Category'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Forum.only_upgraders'
        db.delete_column(u'forum_forum', 'only_upgraders')

        # Deleting field 'Forum.category'
        db.delete_column(u'forum_forum', 'category_id')
